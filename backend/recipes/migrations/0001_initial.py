    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(validators=[recipes.validators.validate_positive], verbose_name='Время приготовления')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(validators=[recipes.validators.validate_positive], verbose_name='Количество')),
